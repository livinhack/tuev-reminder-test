...
- create/detail form is now a modal overlay
- text/number fields keep focus while typing
- Save/Create remains disabled

Card behavior is unchanged and the Card repository remains separate.
