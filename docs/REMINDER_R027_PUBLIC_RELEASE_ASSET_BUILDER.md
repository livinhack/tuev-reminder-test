# Reminder r027 – Public Release Asset Builder

r027 does not change runtime behavior. It adds a small release-asset builder for the final public `v0.1.0` package.
...
To avoid manually editing release metadata, r027 adds:
