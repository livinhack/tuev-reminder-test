# Reminder r051 – Mobile Action Hit Target Fix

Follow-up to r050 responsive table width. r051 keeps the table layout but improves mobile touch reliability for the per-row three-dot actions.
