#!/usr/bin/env python3
"""Validate r048 Sidebar three-dot action menu shell."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r048 three-dot action menu check failed: {message}")
...
def main() -> None:
    ...
    print("r048 three-dot action menu check OK")
