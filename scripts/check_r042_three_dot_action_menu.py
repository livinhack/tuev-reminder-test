#!/usr/bin/env python3
"""Validate r049 Sidebar three-dot action menu shell."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 three-dot action menu check failed: {message}")
...
def main() -> None:
    ...
    print("r049 three-dot action menu check OK")
