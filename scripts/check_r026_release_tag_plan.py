...
plan = read("docs/REMINDER_R027_PUBLIC_RELEASE_ASSET_BUILDER.md")
...
for needle in [
    ...
    assert_contains(plan, needle, "r027 release tag/package plan")
...
print("r027 release tag/package plan check OK")
