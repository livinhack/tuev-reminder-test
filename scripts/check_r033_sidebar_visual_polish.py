#!/usr/bin/env python3
"""Validate r050 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r050 sidebar visual polish check failed: {message}")
...
print("r050 sidebar visual polish check OK")
