#!/usr/bin/env python3
"""Validate r039 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r039 sidebar visual polish check failed: {message}")
...
print("r039 sidebar visual polish check OK")
