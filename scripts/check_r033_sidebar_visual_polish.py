#!/usr/bin/env python3
"""Validate r049 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 sidebar visual polish check failed: {message}")
...
print("r049 sidebar visual polish check OK")
