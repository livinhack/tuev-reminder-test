#!/usr/bin/env python3
"""Validate r036 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r036 sidebar visual polish check failed: {message}")


manifest = json.loads(read("custom_components/tuev_reminder/manifest.json"))
if manifest.get("version") != "0.1.0-r036":
    fail("manifest version must be 0.1.0-r036")
if read("REMINDER_VERSION.txt").strip() != "r036":
...
print("r036 sidebar visual polish check OK")
