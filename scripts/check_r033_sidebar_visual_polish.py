#!/usr/bin/env python3
"""Validate r047 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r047 sidebar visual polish check failed: {message}")
...
print("r047 sidebar visual polish check OK")
