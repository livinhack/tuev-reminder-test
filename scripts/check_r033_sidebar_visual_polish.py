#!/usr/bin/env python3
"""Validate r052 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r052 sidebar visual polish check failed: {message}")
...
print("r052 sidebar visual polish check OK")
