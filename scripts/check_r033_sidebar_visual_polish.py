#!/usr/bin/env python3
"""Validate r046 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r046 sidebar visual polish check failed: {message}")
...
print("r046 sidebar visual polish check OK")
