#!/usr/bin/env python3
"""Validate r045 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r045 sidebar visual polish check failed: {message}")
...
print("r045 sidebar visual polish check OK")
