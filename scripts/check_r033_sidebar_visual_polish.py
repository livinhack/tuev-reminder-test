#!/usr/bin/env python3
"""Validate r048 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r048 sidebar visual polish check failed: {message}")
...
print("r048 sidebar visual polish check OK")
