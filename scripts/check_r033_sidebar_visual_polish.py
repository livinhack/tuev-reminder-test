#!/usr/bin/env python3
"""Validate r044 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r044 sidebar visual polish check failed: {message}")
...
print("r044 sidebar visual polish check OK")
