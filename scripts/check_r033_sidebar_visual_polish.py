#!/usr/bin/env python3
"""Validate r051 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r051 sidebar visual polish check failed: {message}")
...
print("r051 sidebar visual polish check OK")
