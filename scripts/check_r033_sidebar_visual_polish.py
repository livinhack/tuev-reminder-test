#!/usr/bin/env python3
"""Validate r043 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r043 sidebar visual polish check failed: {message}")
...
print("r043 sidebar visual polish check OK")
