#!/usr/bin/env python3
"""Validate r042 Switch-Manager-style Sidebar visual polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r042 sidebar visual polish check failed: {message}")
...
print("r042 sidebar visual polish check OK")
