#!/usr/bin/env python3
"""Validate r042 Sidebar modal form and input focus fix."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r042 modal form focus fix check failed: {message}")
...
def main() -> None:
    ...
    print("r042 modal form focus fix check OK")
