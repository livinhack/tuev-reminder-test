#!/usr/bin/env python3
"""Validate r051 Sidebar modal form and input focus fix."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r051 modal form focus fix check failed: {message}")
...
def main() -> None:
    ...
    print("r051 modal form focus fix check OK")
