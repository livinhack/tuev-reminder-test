"""Validate r051 Sidebar table column polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r051 sidebar table compact polish check failed: {message}")
...
def main() -> None:
    ...
    print("r051 sidebar table compact polish check OK")
