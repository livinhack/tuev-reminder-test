"""Validate r046 Sidebar table column polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r046 sidebar table compact polish check failed: {message}")
...
def main() -> None:
    ...
    print("r046 sidebar table compact polish check OK")
