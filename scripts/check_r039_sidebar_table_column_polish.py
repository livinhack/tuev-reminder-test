"""Validate r049 Sidebar table column polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 sidebar table compact polish check failed: {message}")
...
def main() -> None:
    ...
    print("r049 sidebar table compact polish check OK")
