"""Validate r052 Sidebar table column polish."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r052 sidebar table compact polish check failed: {message}")
...
def main() -> None:
    ...
    print("r052 sidebar table compact polish check OK")
