...
assert_true(manifest.get("version") == "0.1.0-r013", "manifest version must be r013")
assert_true(read("REMINDER_VERSION.txt").strip() == "r013", "REMINDER_VERSION must be r013")
