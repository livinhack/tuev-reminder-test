...
assert_true(manifest.get("version") == "0.1.0-r019", "manifest version must be r014")
assert_true(read("REMINDER_VERSION.txt").strip() == "r019", "REMINDER_VERSION must be r019")
