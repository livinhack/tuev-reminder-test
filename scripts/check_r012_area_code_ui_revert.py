...
assert_true(manifest.get("version") == "0.1.0-r081", "manifest version must be r023")
assert_true(read("REMINDER_VERSION.txt").strip() == "r081", "REMINDER_VERSION must be r025")
