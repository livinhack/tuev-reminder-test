...
assert_true(manifest.get("version") == "0.1.0-r027", "manifest version must be r023")
assert_true(read("REMINDER_VERSION.txt").strip() == "r027", "REMINDER_VERSION must be r025")
