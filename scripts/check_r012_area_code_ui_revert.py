...
assert_true(manifest.get("version") == "0.1.0-r089", "manifest version must be r023")
assert_true(read("REMINDER_VERSION.txt").strip() == "r089", "REMINDER_VERSION must be r025")
