...
for needle in [
    ...
    assert_contains(const, needle, "r006 suffix flag constant")
...
assert_contains(config_flow, '_season_end_schema', "season end must have a dedicated schema")
assert_contains(config_flow, 'valid_end_options = _season_end_month_options(start_month)', "end month options must be derived from selected start month")
...
for needle in [
    ...
    assert_contains(sensor, needle, "r006 sensor suffix flag")
...
assert_contains(manifest, '"version": "0.1.0-r006"', "manifest version")
assert_contains(readme, "Reminder r006", "README r006")
assert_contains(handover, "Reminder r006", "handover r006")
assert_contains(readme, "plate_suffix_h", "README suffix flag docs")
assert_contains(handover, "No free-text suffix validation", "handover mentions removed suffix validation")

print("r006 suffix checkbox + season month guard check OK")
