#!/usr/bin/env python3
"""Validate r039 Sidebar create form skeleton without enabling writes."""
...
def main() -> int:
    ...
    assert VERSION.read_text(encoding="utf-8").strip() == "r039"
    ...
    for needle in forbidden:
        if needle in js:
            raise AssertionError(f"r039 Sidebar form skeleton must not include {needle!r}")
