...
test_matrix = read("docs/REMINDER_R019_V3_STABILIZATION_TEST_MATRIX.md")
compat = read("docs/COMPAT_CARD_B355_REMINDER_R017.md")
audit = read("docs/REMINDER_R019_RELEASE_READINESS_AUDIT.md")
...
# r018/r019 docs must cover the stabilization scope.
assert_contains(readme, "TÜV Reminder r019", "README r019")
...
assert_contains(test_matrix, "Reminder r019", "test matrix reminder baseline")
...
assert_contains(compat, "Card b355 + Reminder r017/r019", "compat title")
assert_contains(audit, "r017:      detached integration-level calendar entity", "release audit r017")
assert_contains(audit, "r019:      stabilization test matrix", "release audit r019")

print("r018/r019 v3 stabilization checkpoint check OK")
