...
test_matrix = read("docs/REMINDER_R018_V3_STABILIZATION_TEST_MATRIX.md")
compat = read("docs/COMPAT_CARD_B355_REMINDER_R017.md")
audit = read("docs/REMINDER_R018_RELEASE_READINESS_AUDIT.md")
...
# r018 docs must cover the stabilization scope.
assert_contains(readme, "TÜV Reminder r018", "README r018")
assert_contains(handover, "V3 Stabilization Test Matrix", "handover title")
assert_contains(test_matrix, "Card b355", "test matrix card baseline")
assert_contains(test_matrix, "Reminder r018", "test matrix reminder baseline")
...
assert_contains(compat, "Card b355 + Reminder r017/r018", "compat title")
assert_contains(audit, "r017:      detached integration-level calendar entity", "release audit r017")
assert_contains(audit, "r018:      stabilization test matrix", "release audit r018")

print("r018 v3 stabilization checkpoint check OK")
