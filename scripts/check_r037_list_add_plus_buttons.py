#!/usr/bin/env python3
"""Validate r044 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r044 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r044 list add plus buttons check OK")
