#!/usr/bin/env python3
"""Validate r046 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r046 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r046 list add plus buttons check OK")
