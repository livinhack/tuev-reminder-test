#!/usr/bin/env python3
"""Validate r049 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r049 list add plus buttons check OK")
