#!/usr/bin/env python3
"""Validate r039 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r039 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r039 list add plus buttons check OK")
