#!/usr/bin/env python3
"""Validate r048 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r048 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r048 list add plus buttons check OK")
