#!/usr/bin/env python3
"""Validate Sidebar create action compatibility under current compact controls."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r053/r097 list create action check failed: {message}")
...
def main() -> None:
    ...
    if VERSION.read_text(encoding="utf-8").strip() != "r114":
    ...
    print("r053/r097 list create action check OK")
