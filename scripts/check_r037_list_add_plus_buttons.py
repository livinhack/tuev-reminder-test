#!/usr/bin/env python3
"""Validate r047 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r047 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r047 list add plus buttons check OK")
