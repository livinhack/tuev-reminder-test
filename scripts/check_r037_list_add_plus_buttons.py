#!/usr/bin/env python3
"""Validate r052 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r052 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r052 list add plus buttons check OK")
