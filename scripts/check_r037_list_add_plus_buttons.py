#!/usr/bin/env python3
"""Validate r045 Sidebar list add plus buttons."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r045 list add plus buttons check failed: {message}")
...
def main() -> None:
    ...
    print("r045 list add plus buttons check OK")
