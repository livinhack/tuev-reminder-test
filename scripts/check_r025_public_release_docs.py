...
install = read("docs/REMINDER_R027_PUBLIC_RELEASE_ASSET_BUILDER.md")
...
for text, label in [
    (readme, "README"),
    (handover, "HANDOVER"),
    (install, "r027 release tag plan"),
    (compat, "r027 compat doc"),
]:
...
for needle in [
    ...
    assert_contains(install, needle, "r027 release tag plan")
...
assert_contains(compat, "Reminder r027", "r027 compat version")
assert_contains(changelog, "r027", "CHANGELOG r027 entry")

print("r025 public release docs compatibility check OK for current r027 docs")
