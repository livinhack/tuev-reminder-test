...
assert manifest["version"] in {"0.1.0-r010", "0.1.0-r012", "0.1.0-r014", "0.1.0-r017", "0.1.0-r020", "0.1.0-r028", "0.1.0-r032", "0.1.0-r047"}
assert read("REMINDER_VERSION.txt").strip() in {"r010", "r012", "r014", "r017", "r020", "r023", "r024", "r028", "r029", "r030", "r031", "r032", "r047"}
