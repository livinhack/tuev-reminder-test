#!/usr/bin/env python3
"""Validate r045 Backend Create API foundation and plain add controls."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r045 backend create API check failed: {message}")
...
def main() -> None:
    ...
    print("r045 backend create API check OK")
