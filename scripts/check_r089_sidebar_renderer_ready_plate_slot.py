...
for needle in required:
    if needle not in text:
        raise SystemExit(f"Missing expected r089 marker: {needle}")
...
if '0.1.0-r089' not in manifest:
    raise SystemExit('manifest version was not bumped to 0.1.0-r089')
if version != 'r089':
    raise SystemExit(f'REMINDER_VERSION.txt should be r089, got {version!r}')

print("r089 Sidebar renderer-ready plate slot check passed.")
