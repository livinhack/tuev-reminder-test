#!/usr/bin/env python3
"""Validate r050 Sidebar modal bottom action placement."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r050 modal actions bottom check failed: {message}")
...
def main() -> None:
    ...
    if '"version": "0.1.0-r050"' not in manifest:
    ...
    print("r050 modal actions bottom check OK")
