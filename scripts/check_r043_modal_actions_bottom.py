#!/usr/bin/env python3
"""Validate r051 Sidebar modal bottom action placement."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r051 modal actions bottom check failed: {message}")
...
def main() -> None:
    ...
    if '"version": "0.1.0-r051"' not in manifest:
    ...
    print("r051 modal actions bottom check OK")
