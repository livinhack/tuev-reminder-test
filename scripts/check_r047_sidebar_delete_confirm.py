#!/usr/bin/env python3
"""Validate r049 Sidebar delete confirm flow."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 sidebar delete confirm check failed: {message}")
...
print("r049 sidebar delete confirm check OK")
