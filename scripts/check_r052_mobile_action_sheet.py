"""Validate r052 mobile action-sheet behavior."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r052 mobile action-sheet check failed: {message}")
...
require(panel, "@media (max-width: 900px)", "landscape compact breakpoint")
...
print("r052 mobile action-sheet check OK")
