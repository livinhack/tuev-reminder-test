#!/usr/bin/env python3
"""Validate r049 Sidebar dirty guard and unchanged edit save behavior."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r049 sidebar dirty guard check failed: {message}")
...
def main() -> int:
    ...
    if VERSION.read_text(encoding="utf-8").strip() != "r049":
    ...
    print("r049 sidebar dirty guard check OK")
    return 0
