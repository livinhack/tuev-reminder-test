#!/usr/bin/env python3
"""Validate r045 Sidebar edit/update save wiring."""
...
def fail(message: str) -> None:
    raise SystemExit(f"r045 sidebar update form save check failed: {message}")
...
def main() -> None:
    ...
    print("r045 sidebar update form save check OK")
